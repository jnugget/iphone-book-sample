...
- (void)viewDidLoad {
  ...
  if ( !items_ ) {
    items_ = [[NSArray alloc] initWithObjects:
                                @"SampleForLabel",
                                @"SampleForDrawingStrings",
                                @"SampleForDrawingStringsInRect",
                                @"SampleForLineBreak",
                                ...
                                @"SampleForUIImage",
                                @"SampleForBlendMode",
                                @"SampleForImageWithCap",
                                @"SampleForUIImageViewAnimation",
                                @"SampleForAnimationMove",
                                @"SampleForAnimationRepeat",
                                @"SampleForAnimationCurve",
                                @"SampleForAnimationTransform",
                                @"SampleForAnimationObserving",
                                @"SampleForTransition",
                                @"SampleForOpaque",
                                nil ];
  } 
