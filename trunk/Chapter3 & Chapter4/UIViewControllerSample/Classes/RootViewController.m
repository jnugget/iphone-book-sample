...
- (void)viewDidLoad {
  ...
  if ( !items_ ) {
    items_ = [[NSArray alloc] initWithObjects:
                                ...
                                @"SampleForTitleView",
                                @"SampleForToolbar",
                                @"SampleForToolbarSystemItem",
                                @"SampleForToolbarWithSpace",
                                @"SampleForBarButtonWithTitle",
                                @"SampleForCustomBarButton",
                                @"SampleForFullScreen",
                                @"SampleForFullScreenWithTransparent",
                                @"SampleForStatusBarColor",
                                @"SampleForRotate",
                                @"SampleForRotateAndAutoresizing",
                                @"SampleForRotateManual",
                                @"SampleForRotateAndFullScreen",
                                @"SampleForObserving",
                                @"SampleForBarColor",
                                nil ];
  } 
